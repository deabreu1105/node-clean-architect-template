...
Punto de entrada único para Claude Code y para los 7 subagentes SDD de `.claude/agents/`
(`leader`, `ideator`, `api_designer`, `spec_author`, `implementer`, `reviewer`,
`security_auditor`). Léelo primero y sigue sus referencias. `AGENTS.md` solo redirige
aquí.
