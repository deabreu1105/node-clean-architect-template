...
## R1
CUANDO el usuario ejecuta `node src/cli.js recent` sin pasar `--limit`,
el sistema DEBE imprimir como máximo 5 notas en stdout.

## R2
CUANDO el usuario ejecuta `node src/cli.js recent --limit <N>` con un
...
## R5
CUANDO el usuario ejecuta `node src/cli.js recent` y no existe ninguna
nota almacenada, el sistema DEBE salir con exit code `0` sin escribir nada
en stdout.

## R6
SI el usuario ejecuta `node src/cli.js recent --limit <N>` con `N <= 0`
...
|-----------------------------------------------------------------------------------------|--------------|
| `node src/cli.js recent` lista las 5 notas más recientes por defecto                    | R1, R3       |
| `node src/cli.js recent --limit 10` permite cambiar el número                           | R2           |
